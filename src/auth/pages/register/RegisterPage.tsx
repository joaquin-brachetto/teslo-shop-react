  ...
  return (
    <div className={"flex flex-col gap-6"}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleRegister}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input id="username" type="text" name="fullName" placeholder="Nombre de usuario" required />
              </div>
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <Input id="password" type="password" required name="password" placeholder="Contraseña" />
              </div>
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        Haciendo click, estas de acuerdo con los{' '}<a href="#">términos y servicios</a> y <a href="#">políticas de uso</a>.
      </div>
    </div>
  )
}