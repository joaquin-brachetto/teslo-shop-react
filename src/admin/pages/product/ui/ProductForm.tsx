...
export const ProductForm = ({ title, subTitle, product, onSubmit, isPending }: Props) => {
    ...
    const { register, formState: { errors }, getValues, setValue, watch, handleSubmit } = useForm<FormInputs>({
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {
                                        errors.title && (
                                            <p className='text-sm text-red-500'>El titulo es requerido</p>
                                        )
                                    }
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        />
                                        {
                                            errors.price && (<p className='text-sm text-red-500'>El precio debe ser mayor a 0</p>)
                                        }
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {
                                            errors.stock && (<p className='text-sm text-red-500'>El stock debe ser mayor a 0</p>)
                                        }
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {
                                        errors.slug && (<p className='text-sm text-red-500'>{errors.slug.message || 'El slug es requerido'}</p>)
                                    }
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {
                                        errors.description && (<p className='text-sm text-red-500'>La descripción es requerida</p>)
                                    }
                                </div>
                            </div>
                        </div>
