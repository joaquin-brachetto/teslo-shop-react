        ...
        <TableBody>
          {
            data?.products.map(product => (
              <TableRow key={product.id}>
                ...
                <TableCell><Link to={`/admin/products/${product.id}`} className='hover: text-blue-500 underline'>
                  {product.title}
                </Link></TableCell>
                ...
                <TableCell className="text-right">
                  ...
                  <Link to={`/admin/products/${product.id}`}><PencilIcon className='w-4 h-4 text-blue-500' /></Link>
                </TableCell>
              </TableRow>
            ))
          }
