...
export const CustomHeader = () => {
  ...
  const { authStatus, logout, isAdmin } = useAuthState()
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:flex items-center space-x-2">
            <div className="relative">
              ...
              <Input ref={inputRef} onKeyDown={handleSearch} defaultValue={query} placeholder="Buscar productos..." className="pl-9 w-64 h-9" />
            </div>
          </div>
